...
class VideoPlayer extends Component {
  ...
  componentDidMount() { // referencia para verificar en que estado estamos y cambiar el estado que esta en pausa
    this.setState({
  ...
  handleVolumeChange = event => { // manejar el full screen
